  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          {/* Use locationName directly from the store */}
          <DialogTitle>编辑盒子: {locationName || 'Loading...'}</DialogTitle>
        </DialogHeader>

        {/* Check if essential config is loaded before rendering tabs */}
            ...
            <TabsContent value="network" className="mt-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="ip-address"
                  placeholder="请输入IP地址"
                  value={networkConfig.ipAddress ?? ''} // Handle potential null/undefined initially
